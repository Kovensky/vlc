...
static void arib_initialize_decoder( arib_decoder_t* decoder )
{
    decoder->buf = NULL;
    decoder->count = 0;
    decoder->ubuf = NULL;
...
static void arib_initialize_decoder_a_profile( arib_decoder_t* decoder )
{
...
static void arib_initialize_decoder_c_profile( arib_decoder_t* decoder )
{
    arib_initialize_decoder( decoder );
